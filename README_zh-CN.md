...
**📌 说明**：当你说"不确定要什么"，顾问运行**本地澄清菜单**（`scripts/clarify_loop.py`，有界 1–3 问/轮、硬上限 3 轮），而不是猜测。澄清后**对 enriched 问题重新跑难度判定**，按路由表走本地编排器（数据智能）或 Coze，并带 `difficulty="vague"`。
...
**版本**：v0.9.69 | **许可证**：MIT | **作者**：medstatstar, phoe-zip
